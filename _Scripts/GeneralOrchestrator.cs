            ...
            if (networkManager.GetMatchOrchestrator() != null) {
                switch (curState) {
                    case 1:
                        ...
                        if (!networkManager.isHider())
                            seekerCountdownTXT.text = networkManager.GetMatchOrchestrator().getHidingRemainingTime() + " s";
                        else {

                            playerCountdownTXT.text = networkManager.GetMatchOrchestrator().getHidingRemainingTime() + " s";
                        }
                        checkRemovedPlayers();
                        break;
                    case 2:
                        ...
                        checkRemovedPlayers();
                        playerCountdownTXT.text = networkManager.GetMatchOrchestrator().getSeekingRemainingTime() + " s";
                        break;
                    case 3:
                        if (state != curState) {
                            state = curState;
                        ...
                        if (!networkManager.isCaught())
                            playerCountdownTXT.text = networkManager.GetMatchOrchestrator().getMatchRemainingTime() + " s";
                        else {
                            if (!canvasLobby || !canvasLobby.activeSelf)
                                exitMidMatchToScoreboard();
                            lobbyCountdownTXT.text = networkManager.GetMatchOrchestrator().getMatchRemainingTime() + " s";
                        }
                        break;
                    case 4:
                        if (state != curState) {
                        ...
                        lobbyCountdownTXT.text = networkManager.GetMatchOrchestrator().getScoreboardRemainingTime() + " s";
                        break;
                    case 5:
                        goto case 1;
                    case 6:

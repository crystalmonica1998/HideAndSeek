...
public class HostNetwork {
    ...
    private void ProcessNewGuest(Guest guest, string guestName, string IPv4) {
        ...
        //Debug.Log("Processing new client "+guestName);
        if (guests.Count > MAX_GUESTS - 1) { // Including the host (this)
            ...
            guest.IPv4 = IPv4;
            //guest.playerController.instantiatePlayerModel();
    ...
    public void StartLobby() {
        ...
        try {
            ...
            StartListening();
            lobbyStarted = true;
            Debug.Log("Lobby has been started on port " + PORT.ToString());
...
public class Guest {
    ...
    public int hidingWins, seekingWins;
